...
private:
	...
	friend ModelClass* InitializeModel(GraphicsClass* pGraphics, const string& modelFilename, const string& modelId, WCHAR* textureName1, WCHAR* textureName2 = nullptr); // initialize a single model by its name and textures
