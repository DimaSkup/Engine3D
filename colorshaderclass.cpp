...
bool ColorShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
	...
	result = InitializeShader(device, hwnd, L"../Engine/Shaders/color.vs", L"../Engine/Shaders/color.ps");
	if (!result)
	{
		return false;
	}
										...
										WCHAR* vsFilename, WCHAR* psFilename)
{
	...
	if (FAILED(result))
	{
		...
		// could not find the shader file itself
		else
		{
	...
	// Get a count of the elemnts in the layout
	...
	D3DXMATRIX viewMatrix, D3DXMATRIX projectionMatrix)
{
	...
	// Transpose the matrices before sending them into the shader, this is a requirement for DirectX 11
