						 ...
						 int positionX, int positionY)
{
	...
	// to possibly a different location on the screen 
...
bool BitmapClass::InitializeBuffers(ID3D11Device* device)
{
	...
	// Release the arrays now that the vertex and 
	// index buffers have been created and loaded
	delete[] vertices;
	vertices = 0;
								...
								int positionX, int positionY)
{
	...
	// If the position we are rendering this bitmap to has 
	// not changed then don't update the vertex buffer since it
	if ((positionX == m_previousPosX) && (positionY == m_previousPosY))
	{
		return true;
	}

	// If it has changed then update the position 
	// it is rendered to
	...
	// Calculate the screen coordinates of the right size of the bitmap
