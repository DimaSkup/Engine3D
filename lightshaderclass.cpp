...
bool LightShaderClass::InitializeShader(ID3D11Device* device, HWND hwnd, WCHAR* vsFilename, WCHAR* psFilename)
{
	...
	// Setup the description of the camera dynamic constant buffer that
	...
	// Create the camera constant buffer pointer so we can access
...
void LightShaderClass::ShutdownShader()
{
	...
	// Release the camera constant bufferr
	if (m_cameraBuffer)
	{
											...
											float specularPower)
{
	...
	// Now set the camera constant buffer in the vertex shader
